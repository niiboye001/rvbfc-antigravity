      ...
      >
        ...
        {!hasSeasonForYear ? (
          <View className="px-6 mb-8 mt-6">
            <View className="bg-white p-8 rounded-3xl border border-blue-50 shadow-sm shadow-blue-100 items-center">
              ...
              {Config.isClientApp ? (
                <>
                  <Text className="text-slate-500 text-center font-medium leading-6 mb-6">
                    The {currentYear} season hasn't started yet.
                    {"\n"}Stay tuned for upcoming matches and stats!
                  </Text>
                ...
                <>
                  <Text className="text-slate-500 text-center font-medium leading-6 mb-6">
                    No active season found for {currentYear}.
                    {"\n"}Create one to start managing the league.
                  </Text>
                  <TouchableOpacity
